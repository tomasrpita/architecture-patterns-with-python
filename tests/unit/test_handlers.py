...
class TestAddBatch:
    ...
    def test_for_existing_product(self):
        ...
        bus.handle(commands.CreateBatch("b1", "CRUNCHY-ARMCHAIR", 100, None))
        bus.handle(commands.CreateBatch("b2", "CRUNCHY-ARMCHAIR", 100, None))
...
class TestAllocate:
    ...
    def test_errors_for_invalid_sku(self):
        ...
        bus.handle(commands.CreateBatch("batch-1", "sku-0", 100, "2011-01-01"))
    ...
    def test_commits(self):
        ...
        bus.handle(commands.CreateBatch("batch-1", "sku-1", 100, "2011-01-01"))
    ...
    def test_sends_email_on_out_of_stock_error(self):
        ...
        bus.handle(commands.CreateBatch("batch-1", "POPULAR-CURTAINS", 9, "2011-01-01"))
